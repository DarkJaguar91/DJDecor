...
public interface DJHeaderPositionCalculator {
     ...
     */
    boolean isFirstView(View view, ViewGroup parent, int orientation, boolean isReversed);
     ...
     */
    Point getPositionForHeader(View view, View header, ViewGroup parent, int position, boolean isFirstView, int orientation, boolean isReversed);
}
